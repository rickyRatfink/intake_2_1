...
<logic:equal name="onlineAppForm" property="messageType" value="error">
	<table width="437" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td background="<%=request.getContextPath()%>/images/standard/error_body.jpg" valign="top">
					<div id="errors">
						<ul>
						<logic:iterate id="messages" name="onlineAppForm" property="messages">
...
<logic:equal name="onlineAppForm"  property="messageType" value="info">
...
<logic:equal name="onlineAppForm"  property="messageType" value="success">
		<table width="434" cellpadding="0" cellspacing="0" border="0">
		<tr>
...
<logic:equal name="onlineAppForm" property="messageType" value="warning">
		<table width="434" cellpadding="0" cellspacing="0" border="0">
		<tr>
