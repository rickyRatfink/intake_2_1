 ...
 * @see com.yada180.sms.domain.Address
	...
	public List findByExample(Address instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.yada180.sms.domain.Address")
